    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/pelatihan/simpan/<?php echo isset($id)?$id:''; ?>" method="post" name="submit">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-4" for="tanggal_akhir">Tanggal AKhir</label>
                    <div class="col-sm-6">
                    <input required type="text" class="form-control" id="tanggal_akhir" name="tanggal_akhir" value="<?php echo set_value('tanggal_akhir');?>" placeholder="yyyy-mm-dd">
                	</div><br><br>
                </div>
                <div class="form-group">
						...
						<div class="row text-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  						...
  						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
								...
								<th data-field="nama_pelatihan" data-align="center" data-sortable="true">Nama pelatihan</th>
								<th data-field="tanggal_mulai" data-align="center" data-sortable="true">Tanggal Mulai</th>
								<th data-field="tanggal_akhir" data-align="center" data-sortable="true">Tanggal Berakhir</th>
								<th data-field="tempat_diklat" data-align="center" data-sortable="true">Tempat Diklat</th>
						...
						<div class="modal fade" id="edit<?php echo $row->id ; ?>" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
						    ...
						    <div class="modal-dialog">
						        <div class="modal-content">
						            ...
						            <div class="modal-body">
						            <form action="<?php echo base_url();?>index.php/pelatihan/edit/<?php echo isset($id)?$id:''; ?>" method="post" name="submit">
						                <div class="box-body">
						                <div class="form-group">
						                    <label class="control-label col-sm-4" for="nama_pelatihan">ID</label>
						                    <div class="col-sm-6">
						                ...
						                <div class="form-group">
						                    <label class="control-label col-sm-4" for="nama_pelatihan">Nama Pelatihan</label>
						                    <div class="col-sm-6">
						                    <input required type="text" class="form-control" id="nama_pelatihan" name="nama_pelatihan" value="<?php echo $row->nama_pelatihan;?>">
						                    </div><br><br>
						                </div>
						                <div class="form-group">
						                    <label class="control-label col-sm-4" for="tanggal_mulai">Tanggal Mulai</label>
						                ...
						                <div class="form-group">
						                    <label class="control-label col-sm-4" for="tanggal_akhir">Tanggal Akhir</label>
						                    <div class="col-sm-6">
						                    <input required type="text" class="form-control" id="tanggal_akhir" name="tanggal_akhir" value="<?php echo $row->tanggal_akhir;?>">
						                    </div><br><br>
						                </div>
						                <div class="form-group">
						                    <label class="control-label col-sm-4" for="tempat_diklat">Tempat Diklat</label>
						                    <div class="col-sm-6">
						                    <input required type="text" class="form-control" id="tempat_diklat" name="tempat_diklat" value="<?php echo $row->tempat_diklat;?>">
						                    </div><br><br>
						                </div>
						                <div class="form-group">
						                    <label class="control-label col-sm-4" for="keterangan">Keterangan</label>
